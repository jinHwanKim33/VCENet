...
class Environment:
    ...
    def __init__(
        ...
        detection_feature_file_name='det_feature_22_cates_detr.hdf5', #'det_feature_22_cates.hdf5',
        images_file_name='resnet18_featuremap.hdf5',
        visible_object_map_file_name='visible_object_map.json',
        local_executable_path=None,
        optimal_action_file_name='optimal_action.json',  #hwan
    ):
    ...
    def random_reachable_state(self, seed=None):
        ...
        horizon = random.choice([0, 30, 330]) # ? 330?
        state = copy.copy(xyz)
