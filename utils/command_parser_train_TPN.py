...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        default=1.0,
        metavar='G',
        help='discount factor for il loss (default: 0.9)',
    )
    ...
    ## have to revise this argument at second stage(training for TPN)
    parser.add_argument(
        '--continue-training',
        type=str,
        default='trained_models_VCENet/VCENet_30414895_2500000_2023_11_09_00_31_41.dat',
    ...
    parser.add_argument(
        '--data-dir',
        type=str,
        default='/media/ailab8503/484d268c-c692-47d6-800f-b6c2d2f92790/ORG-Depth-reward/AI2Thor_offline_data_2.0.2',
    ...
    parser.add_argument(
        ...
        type=str,
        default='det_feature_22_cates_detr.hdf5',
    ...
    parser.set_defaults(strict_done=True)  #hwan default = True
    ...
    parser.add_argument(
        '--update-meta-network',
        action='store_false',    ##TPN learning
...
######
    ...
    #     "--collision_reward",
    #     default=True,
    #     help="using collision reward with depth"
    # )

    # parser.add_argument(
    #     "--closer_reward",
    #     default=True,
    #     help="using closer reward with optimal path"
    # )
